...
public class Context {
	...
	double[] unbiasedData = { playerPos[allyTeamId][order[0]].x, playerPos[allyTeamId][order[0]].y,
		relativeData[BALL_X], relativeData[BALL_Y], relativeData[BALL_VX], relativeData[BALL_VY],
		playerPos[allyTeamId][order[1]].x, playerPos[allyTeamId][order[1]].y, playerPos[allyTeamId][order[2]].x,
